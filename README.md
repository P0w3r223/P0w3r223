...
- **[mini-traceroute](https://github.com/P0w3r223/mini-traceroute)** — traceroute written from scratch in C++ over raw sockets.
- **[auth-log-scan](https://github.com/P0w3r223/auth-log-scan)** — an OpenSSH auth-log scanner for brute-force and suspicious logins.
