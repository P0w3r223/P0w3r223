...
| **[apply-scout](https://github.com/P0w3r223/apply-scout)** | An LLM agent — a from-scratch tool loop with safety budgets and guardrails — that matches a job posting against a CV and GitHub evidence, with an evaluation that scores its own retriever and its own attack surface, offline from a committed recording. | [demo](https://p0w3r223.github.io/apply-scout/) |
