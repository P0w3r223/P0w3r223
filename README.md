...
many metrics — each measured on simulated experiments where the truth is known, each with its
correction. · **[live demo](https://p0w3r223.github.io/ab-lab/)**
...
The Polish IT job market measured honestly — census population frame, bounded attribute
sampling, a data contract, and a published Parquet artifact the page is built from.
· **[live demo](https://p0w3r223.github.io/it-job-radar/)**

## The rest of the index

Same standard, same quoting rule: the italic line is the page's own opening claim.

| Project | What its page claims | Live |
|---|---|---|
...
| **[car-price-ml](https://github.com/P0w3r223/car-price-ml)** | *A 13.9 MB model prices this market better than a 590 MB one* — the full ML cycle end to end, a model that refuses the cars it cannot price, and a FastAPI + Docker service. It also runs in your browser. | [demo](https://p0w3r223.github.io/car-price-ml/) |
...
| **[pl-review-sense](https://github.com/P0w3r223/pl-review-sense)** | *HerBERT reaches 0.986 against the baseline's 0.944* — Polish review sentiment on PolEmo 2.0, right on 38 reviews it misses and wrong on 7 it gets, p < 0.0001. | [demo](https://p0w3r223.github.io/pl-review-sense/) |
...
| **[auth-log-scan](https://github.com/P0w3r223/auth-log-scan)** | *108 failed logins in 7.1 hours — and only some of them are an attack* — brute force, user enumeration, and logins that succeed from an address that had been failing. | [demo](https://p0w3r223.github.io/auth-log-scan/) |
...
- **MLOps** — MLflow, drift monitoring, model registries, Docker, FastAPI
